...
export const SEED_VENTURES = [
  ...
  },
  {
    ...
    active: 1,
    positioning: 'A growing register of cities, ranked in real time across twelve verticals: food, transport, entertainment, health, education, sport, finance, fashion, property, tech, work and pulse. Built under RenviaIT. It reads the world’s cities the way a market is read: continuously, and without holidays. The register is open and still opening: cities are added continuously, by public submission and by the house’s own research, so never state or imply a fixed total, a cap, or a finished list.',
